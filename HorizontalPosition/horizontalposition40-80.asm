...
P0XMax	byte		; Max sprite X coordinate
P0XMin	byte		; Min sprite X coordinate
...
; ---------------------------------------------------------------
	...
	lda #80
	sta P0XMax	; Initialize maximum X coordinate
	lda #40
	sta P0XMin	; Initialize minimum X coordinate
...
; ---------------------------------------------------------------
	lda P0XPos	; Load current X position
	sec		; Set carry flag
	sbc P0XMax
	bpl IsPlus
	jmp IsMinus
IsPlus:
	lda P0XMin	; Load min X position
	sta P0XPos	; Set new X position
IsMinus:
	inc P0XPos
